---
name: apple-design
description: Apple's fluid-interface craft translated to the web — springs, velocity handoff, momentum projection, interruptibility, translucent materials, size-specific typography, and the eight design principles. Use when building or reviewing any ARGILETTE.shop interface, animation, gesture, sheet, drawer, toolbar, or type scale; when a motion "feels off"; or when deciding timing, easing, blur, tracking, or reduced-motion behaviour.
---
...
> **ARGILETTE.shop note:** this file is the upstream source of truth, vendored verbatim from
> [emilkowalski/skills](https://github.com/emilkowalski/skills/blob/main/skills/apple-design/SKILL.md)
> apart from the frontmatter above and this block. Where its guidance meets our own constraints —
> RTL Arabic, 10 locales, strict CSP with no `unsafe-inline`, asynchronous mobile-money checkout —
> the resolutions live in [`docs/design-system.md`](../../../docs/design-system.md). Read that file
> alongside this one; it never contradicts this one, it makes it concrete.
